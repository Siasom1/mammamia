...
export default function CheckoutPage() {
  ...
  // Redirect ONLY in browser (fix for SSR)
  useEffect(() => {
    if (cart.length === 0) {
      router.push("/cart")
    }
  ...
  // Show lightweight message during redirect
  if (cart.length === 0) {
    return (
      <div className="p-10 text-center text-lg">
        Winkelwagen is leeg, je wordt doorgestuurd...
      </div>
    )
  }
        ...
        <div className="container flex h-16 items-center justify-between px-4">
          <Link href="/" className="flex items-center gap-2">
            <img
              ...
              alt="MAMMAMIA Grillroom & Shoarma"
                  ...
                  <div className="flex items-center space-x-3 p-4 border rounded-lg hover:bg-muted/50">
                    ...
                    <Label htmlFor="delivery" className="flex-1 cursor-pointer">
                      <div className="flex gap-3">
                        ...
                        <span>Bezorgen (30–45 min)</span>
                      </div>
                    </Label>
                    <span className="font-medium">€3,50</span>
                  </div>

                  <div className="flex items-center space-x-3 p-4 border rounded-lg hover:bg-muted/50 mt-3">
                    <RadioGroupItem value="pickup" id="pickup" />
                    <Label htmlFor="pickup" className="flex-1 cursor-pointer">
                      <div className="flex gap-3">
                        <Home className="h-5 w-5 text-primary" />
                        <span>Afhalen (20–30 min)</span>
                      </div>
                    </Label>
